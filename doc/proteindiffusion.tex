...
\section{Scaling}
Realistic vesicle-to-cell radii ratios result in diffusion occuring on very small space and time scales. In preparation for the diffusion model implementation, we select a non-dimensionalised time variables, scaled to the vesicle's post-fusion arc-length and diffusivity.
\begin{align*}
	\tau &= \frac{\Par{R_v \varphi_j}^2}{D_v} t
\end{align*}

The weak form becomes
\begin{align*}
	0 &= \Angle{\pdv{u(\phi, \tau)}{\tau} w(\varphi)}
	+ \frac{D_v}{\Par{R_v \varphi_j}^2} \Angle{D(\varphi) \pdv{u(\varphi, t)}{\varphi} \dv{w(\varphi)}{\varphi}}
\end{align*}
...
\section{Scaling}
Realistic vesicle-to-cell radii ratios result in diffusion occuring on very small space and time scales. In preparation for the diffusion model implementation, we select a non-dimensionalised time variables, scaled to the vesicle parameters.
\begin{align*}
	\tau &= \frac{\Rv^2}{D_v} t
\end{align*}
