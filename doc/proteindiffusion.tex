...
\begin{align*}
	U(x, t) &= \sum_{\varphi \in \varphi(x)} u(\varphi, t) I(z(\varphi)) \\
...
\begin{align*}
	U_s(t) &= \int_0^{R_v} U(x, t) \dd{x} \\
	V_s(t) &= \int_0^{R_v} V(x, t) \dd{x} \\
	C_s(t) &= \int_0^{R_v} C(x, t) \dd{x}
\end{align*}
...
\begin{align*}
	U_r(t) &= \int_{R_v}^{2R_v} U(x, t) \dd{x} \\
	V_r(t) &= \int_{R_v}^{2R_v} V(x, t) \dd{x} \\
	C_r(t) &= \int_{R_v}^{2R_v} C(x, t) \dd{x}
\end{align*}
