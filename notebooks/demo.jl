...
md"Vesicle Radius (log scale): $(@bind pRv Slider(-6:1, default = 0))"

# ╔═╡ 3d9cd9a3-a595-4b40-af33-76cedc7bfde1
Rv = 10.0^pRv

# ╔═╡ 90454198-763c-48cb-9bc7-9c2f57b0d9b4
md"Cell Radius (log scale): $(@bind pRc Slider(-4:2, default = 0))"

# ╔═╡ bf481f6d-44e9-4a9b-8cbd-0950e0e5fad4
Rc = 10.0^pRc

# ╔═╡ d295c4f2-cd80-4d86-9c8c-17f6ec9dbc9d
md"Junction Radius (log scale): $(@bind pRj Slider(-6:1, default = 0))"
...
plot(plot(f.arc), plot(k.arc), layout = (1, 2))
